...
async def sarhniHandler(c,m):
    ...
    asyncio.create_task(sarhniFunc(c,m,k))
...
async def sarhniHandlerP(c,m):
    ...
    asyncio.create_task(sarhniFuncP(c,m,k,channel))
